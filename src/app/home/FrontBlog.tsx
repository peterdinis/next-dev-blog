                        ...
                        <div>
                            ...
                            <div className='bg-white px-10 py-6 rounded-bl-3xl rounded-br-3xl'>
                                ...
                                <p className='text-gray-700 text-base lg:text-lg  lg:leading-8 tracking-wide mt-6 w-11/12'>
                                    Find the latest events updates or create
                                    events, concerts, conferences, workshops,
                                    exhibitions, and cultural events in all
                                    cities of the US. The aim of Eventistan is
                                    to promote healthy and entertaining
                                    event.Find the latest events updates or
                                    create events, concerts, conferences,
                                    workshops, exhibitions, and cultural events
                                    in all cities of the US. The aim of
                                    Eventistan is to promote healthy and
                                    entertaining event.
                                </p>
                                ...
                                <div>
                                    ...
                                    <div className='bg-white px-3  lg:px-6 py-4 rounded-bl-3xl rounded-br-3xl'>
                                        ...
                                        <p className='text-gray-700 text-sm  lg:text-base  lg:leading-8 pr-4 tracking-wide mt-2'>
                                            Find the latest events updates or
                                            create events, concerts,
